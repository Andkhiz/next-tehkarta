...
### Шаг 1. Заходим в папку с репозиторием
```bash
cd next-tehkarta
```

### Шаг 2. Отмена всех несохраненных обновлений
```bash
git reset --hard HEAD
```

### Шаг 3. Скачивание обновлений
...
### Шаг 4. Создайте файла `next/web/.env` со строкой подключения:
```bash
# Команда для PowerShell:
...
### Шаг 5. Автоматический перезапуск и применение изменений в Docker
